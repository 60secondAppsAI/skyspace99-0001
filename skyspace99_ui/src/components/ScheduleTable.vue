...
<template>
  ...
  <base-input label="IsPeakTime" type="text" placeholder="Enter IsPeakTime" v-model="scheduleToAdd.isPeakTime"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: 'Is Peak Time',
		dataIndex: 'isPeakTime',
          visible: true,
          scopedSlots: { customRender: 'isPeakTime' },
          sorter: true
          //sorter: (a, b) => a.isPeakTime - b.isPeakTime,
          //sorter: (a, b) => a.isPeakTime.localeCompare(b.isPeakTime),
        },
      ],
      pagination: {
        current: 1,
