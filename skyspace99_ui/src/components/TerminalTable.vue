...
<template>
  ...
  <base-input label="GatesAvailable" type="text" placeholder="Enter GatesAvailable" v-model="terminalToAdd.gatesAvailable"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {
          title: 'Gates Available',
		dataIndex: 'gatesAvailable',
          visible: true,
          scopedSlots: { customRender: 'gatesAvailable' },
          sorter: true
          //sorter: (a, b) => a.gatesAvailable - b.gatesAvailable,
          //sorter: (a, b) => a.gatesAvailable.localeCompare(b.gatesAvailable),
        },
      ],
      pagination: {
        current: 1,
