...
<template>
  ...
  <base-input label="Calories" type="text" placeholder="Enter Calories" v-model="mealToAdd.calories"></base-input>
                  </form>
                </div>
  ...
  data() {
    return {
      ...
      columns: [
		...
		dataIndex: 'calories',
          visible: true,
          scopedSlots: { customRender: 'calories' },
          sorter: true
          //sorter: (a, b) => a.calories - b.calories,
          //sorter: (a, b) => a.calories.localeCompare(b.calories),
        },
      ],
      pagination: {
        current: 1,
