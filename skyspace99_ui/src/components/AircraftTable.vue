    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'manufacturingDate',
          visible: true,
          scopedSlots: { customRender: 'manufacturingDate' },
          sorter: true
          //sorter: (a, b) => a.manufacturingDate - b.manufacturingDate,
		...
		dataIndex: 'totalSeats',
          visible: true,
          scopedSlots: { customRender: 'totalSeats' },
          sorter: true
          //sorter: (a, b) => a.totalSeats - b.totalSeats,
          //sorter: (a, b) => a.totalSeats.localeCompare(b.totalSeats),
        },
      ],
      pagination: {
        current: 1,
