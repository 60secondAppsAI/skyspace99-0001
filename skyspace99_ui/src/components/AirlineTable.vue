...
<template>
  ...
  <base-input label="HeadOffice" type="text" placeholder="Enter HeadOffice" v-model="airlineToAdd.headOffice"></base-input>
  <base-input label="FoundingYear" type="text" placeholder="Enter FoundingYear" v-model="airlineToAdd.foundingYear"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'headOffice',
          visible: true,
          scopedSlots: { customRender: 'headOffice' },
          sorter: true
          //sorter: (a, b) => a.headOffice - b.headOffice,
          //sorter: (a, b) => a.headOffice.localeCompare(b.headOffice),
        },
        {
          title: 'Founding Year',
		dataIndex: 'foundingYear',
          visible: true,
          scopedSlots: { customRender: 'foundingYear' },
          sorter: true
          //sorter: (a, b) => a.foundingYear - b.foundingYear,
          //sorter: (a, b) => a.foundingYear.localeCompare(b.foundingYear),
        },
      ],
      pagination: {
        current: 1,
