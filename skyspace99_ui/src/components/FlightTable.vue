    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'departureCity',
          visible: true,
          scopedSlots: { customRender: 'departureCity' },
          sorter: true
          //sorter: (a, b) => a.departureCity - b.departureCity,
		...
		dataIndex: 'arrivalCity',
          visible: true,
          scopedSlots: { customRender: 'arrivalCity' },
          sorter: true
          //sorter: (a, b) => a.arrivalCity - b.arrivalCity,
