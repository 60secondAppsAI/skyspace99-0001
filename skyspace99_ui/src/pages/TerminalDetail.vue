              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Name</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Gates Available</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="GatesAvailable" type="text" placeholder="Enter GatesAvailable" v-model="terminalDetails.gatesAvailable"></input>
																		</div>
						</td>
														</tr>
