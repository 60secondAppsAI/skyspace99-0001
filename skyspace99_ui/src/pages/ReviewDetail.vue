						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Comments" type="text" placeholder="Enter Comments" v-model="reviewToAdd.comments"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Comments</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Comments" type="text" placeholder="Enter Comments" v-model="reviewDetails.comments"></input>
																		</div>
						</td>
														</tr>
