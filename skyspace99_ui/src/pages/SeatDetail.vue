						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="IsAvailable" type="text" placeholder="Enter IsAvailable" v-model="seatToAdd.isAvailable"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Seat Number</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Is Available</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="IsAvailable" type="text" placeholder="Enter IsAvailable" v-model="seatDetails.isAvailable"></input>
																		</div>
						</td>
														</tr>
