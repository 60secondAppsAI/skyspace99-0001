						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="LicenseNumber" type="text" placeholder="Enter LicenseNumber" v-model="crewToAdd.licenseNumber"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">License Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="LicenseNumber" type="text" placeholder="Enter LicenseNumber" v-model="crewDetails.licenseNumber"></input>
																		</div>
						</td>
														</tr>
